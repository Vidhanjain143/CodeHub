...
const Timer:React.FC<TimerProps> = () => {
    ...
    <div>
        {showTimer ? (
            <div className="flex items-center space-x-2 bg-dark-fill-3 py-1.5 px-1 cursor-pointer rounded hover:bg-dark-fill-2">
